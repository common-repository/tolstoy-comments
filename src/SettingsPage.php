...
class SettingsPage
{
	...
	public static function fields()
	{
		...
		register_setting($group, 'tolstoycomments_import');
		...
		add_settings_section($sectionExport, __('Export/Import', 'tolstoycomments'), '', $section);
		...
		add_settings_field('tolstoycomments_import', __('Enable import', 'tolstoycomments'), array($fields, 'import'), $section, $sectionExport, self::getField('import'));
